...
<div class="content py-3">
                ...
                <div class="col-md-6">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="text-muted">Sale Price: Rs. </span><?= isset($sale_price) ? format_num($sale_price) : '' ?>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <?php else: ?>
                                    <span class="badge badge-danger px-3 rounded-pill">Not Approve</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </fieldset>
    ...
    <div class="row gx-4 gx-lg-5 align-items-top">
        <div class="col-md-12">
            <!-- Map Location -->
            <h4>Map Location</h4>
            <div id="propertyDetailsCard" class="card position-absolute" style="top: 20%; right: 2%; width: 30%; height: 300px; overflow: hidden; display: none;">
                <img style="height: 80%;" src="<?php echo validate_image('uploads/estate_'.$id.'/'.$img."?v=".strtotime($date_updated)) ?>" class="card-img-top" alt="Property Image">
                <div class="card-body">
                    <h6 class="card-title"><?php echo $location ?></h6>
                </div>
            </div>

            <a href="#" onclick="showPropertyDetailsCard()">
                <iframe id="gmap_canvas" width="100%" height="300" src="https://maps.google.com/maps?q=<?= str_replace(" ","",$coordinates) ?>&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="cursor: pointer;"></iframe>
            </a>
        </div>
    </div>
    <!-- Rest of your code -->
...
<script>
    function showPropertyDetailsCard() {
        var propertyDetailsCard = document.getElementById("propertyDetailsCard");
        if (propertyDetailsCard.style.display === "none") {
          ...
          <div class="card-body">
            <form method="post" action="">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="studentName" name="studentEmail" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="propertyId"  readonly value="<?php echo $name ?>" name="propertyId" required>
              </div>
...
<script>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO students_list (student_id, student_name,student_email, student_address, property_name) VALUES ('$studentId', '$studentName','$studentEmail', '$studentAddress', '$propertyId')";
    ...
    if (mysqli_query($conn, $query)) {
      ...
      echo '<script>
        Swal.fire("Error!", "Error adding data: ' . mysqli_error($conn) . '", "error");
      </script>';
    }
